...
#os.system('"C://Program Files/OWASP/Zed Attack Proxy/ZAP.exe"')
#subprocess.run(['C://Program Files/OWASP/Zed Attack Proxy/ZAP.exe'])
#os.system('"C:/Program Files/OWASP/Zed Attack Proxy/ZAP.exe"')

# MANDATORY. Define the target site to test

#SPECIFY THE TARGET IN CMD/BASH WITH: python zapScript2.py [target_url] [file_name]  
...
# MANDATORY. Define the API key generated by ZAP and used to verify actions.
    apiKey='nmurqpgctsset842hjoimof33a'
...
#pprint(core.htmlreport())
    ...
    df = DataFrame(zap.core.alerts(), columns=['alert', 'attack','confidence', 'cweid','description','evidence','id','messageId','method','name','other','param','pluginId','reference','risk','solution','sourceid','url','wascid'])

    export_excel = df.to_excel (r'C:\Users\sknc\Downloads\zapapireports\report_for_' + site + '.xlsx', index = None, header=True) 
